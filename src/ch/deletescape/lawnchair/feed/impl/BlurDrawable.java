...
/**
 * Created by leon on 2/8/16. port Blur from @link https://github.com/500px/500px-android-blur
 *
 * Real time Blur API 17 and above: use blur API 17 lower: use  {@link #setOverlayColor(int color)}
 */
public class BlurDrawable extends ColorDrawable {
        ...
        if (mBlurringCanvas == null
            ...
            if (mBlurredBitmap == null
                ...
                mBitmapToBlur = Bitmap
                        .createBitmap(scaledWidth, scaledHeight, Bitmap.Config.ARGB_8888);
    ...
    /**
     * 渲染任务，可以在16ms完成，可以调用多核 将mBitmapToBlur渲染为mBlurredBitmap输出
     */
    @TargetApi(17)
    ...
    /**
     * force enable blur, however it will only works on API 17 or higher if your want to support
     * more, use Support RenderScript Pack
     */
    ...
    private void drawBlur(Canvas canvas) {
        if (prepare()) {
            ...
            if (mBlurredBgView.getBackground() != null
                ...
                mBitmapToBlur
                        .eraseColor(((ColorDrawable) mBlurredBgView.getBackground()).getColor());
            } else {
