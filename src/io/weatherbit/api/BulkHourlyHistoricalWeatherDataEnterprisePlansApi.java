...
public interface BulkHourlyHistoricalWeatherDataEnterprisePlansApi {
  /**
   ...
   * @return Call&lt;History&gt;
   */
  @GET("bulk/history/hourly?city_id={city_id}")
  Call<History> bulkHistoryHourlycityIdcityIdGet(
   ...
   * @return Call&lt;History&gt;
   */
  @GET("bulk/history/hourly?city={city}&country={country}")
  Call<History> bulkHistoryHourlycitycitycountrycountryGet(
   ...
   * @return Call&lt;History&gt;
   */
  @GET("bulk/history/hourly?ip={ip}")
  Call<History> bulkHistoryHourlyipipGet(
   ...
   * @return Call&lt;History&gt;
   */
  @GET("bulk/history/hourly?lat={lat}&lon={lon}")
  Call<History> bulkHistoryHourlylatlatlonlonGet(
   ...
   * @return Call&lt;History&gt;
   */
  @GET("bulk/history/hourly?postal_code={postal_code}")
  Call<History> bulkHistoryHourlypostalCodepostalCodeGet(
   ...
   * @return Call&lt;History&gt;
   */
  @GET("bulk/history/hourly?station={station}")
  Call<History> bulkHistoryHourlystationstationGet(
