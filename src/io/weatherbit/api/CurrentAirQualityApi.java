...
public interface CurrentAirQualityApi {
  /**
  ...
  Call<AQCurrentGroup> currentAirqualitycityIdcityIdGet(
  ...
  Call<AQCurrentGroup> currentAirqualitycitycitycountrycountryGet(
  ...
  Call<AQCurrentGroup> currentAirqualitylatlatlonlonGet(
  ...
  Call<AQCurrentGroup> currentAirqualitypostalCodepostalCodeGet(
