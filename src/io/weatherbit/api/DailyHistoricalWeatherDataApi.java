...
public interface DailyHistoricalWeatherDataApi {
  ...
  Call<HistoryDay> historyDailycityIdcityIdGet(
  ...
  Call<HistoryDay> historyDailycitycitycountrycountryGet(
   ...
   * @return Call&lt;HistoryDay&gt;
   */
  @GET("history/daily?ip={ip}")
  Call<HistoryDay> historyDailyipipGet(
  ...
  Call<HistoryDay> historyDailylatlatlonlonGet(
  ...
  Call<HistoryDay> historyDailypostalCodepostalCodeGet(
  ...
  Call<HistoryDay> historyDailystationstationGet(
