...
public interface HistoricalWeatherEnergyApiApi {

    /**
     * Returns multiple locations given a bounding box. Returns aggregate energy specific historical
     * weather fields, over a specified time period. Supply a bounding box ex:
     * lat1&#x3D;40&amp;lon1&#x3D;-78&amp;lat2&#x3D;38&amp;lon2&#x3D;-80. This API will return UP TO
     * 150 stations, aggregated by the specified time period start_date to end_date.
     *
    ...
    /**
     * Returns Energy API response  - Given a single lat/lon. Returns aggregate energy specific
     * historical weather fields, over a specified time period.
     *
