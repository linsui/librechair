...
public final class PluginManager {
    ...
    /**
     * Access to the plugin clients for outside classes. Throws IllegalArgumentException if cls is
     * invalid.
     *
    ...
    /**
     * Connects to plugins that are enabled and not connected yet. Disconnects from disabled
     * plugins.
     */
    ...
    public class Plugin {
        ...
        /**
         * Sets the state of this plugin to be either enabled or disabled. If this plugin is
         * exclusive, setting it to enabled will disable other plugins.
         *
