...
class RSSSourcesPreference(context: Context, attrs: AttributeSet?) :
    ...
    private val rssPref = context.lawnchairPrefs.feedRSSSources
    ...
    override fun onAttached() {
        super.onAttached()
        rssPref.addListener(this)
    }

    override fun onDetached() {
        super.onDetached()
        rssPref.removeListener(this)
    }
    ...
    override fun getDialogLayoutResource() = R.layout.pref_dialog_rss_providers
}
