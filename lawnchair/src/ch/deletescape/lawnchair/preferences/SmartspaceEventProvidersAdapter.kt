...
class SmartspaceEventProvidersAdapter(private val context: Context)
    : androidx.recyclerview.widget.RecyclerView.Adapter<SmartspaceEventProvidersAdapter.Holder>() {
    ...
    companion object {
        ...
        fun getEventProviders(context: Context): List<String> {
            ...
            list.add(OngoingEventsProvider::class.java.name)
            ...
            list.add(CompatSmartspaceProvider::class.java.name)
