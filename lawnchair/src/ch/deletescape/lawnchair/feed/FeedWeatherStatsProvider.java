...
public class FeedWeatherStatsProvider extends FeedProvider implements Listener {

    private WeatherData weatherData;

    public FeedWeatherStatsProvider(Context c) {
        super(c);
    ...
    public List<Card> getCards() {
        ...
        return weatherData != null ? Collections
                .singletonList(new Card(new BitmapDrawable(getContext().getResources(),
