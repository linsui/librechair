...
class ITNAdapter(val list: List<NewsItem>, val feedController: FeedController?) : androidx.recyclerview.widget.RecyclerView.Adapter<ITNViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ITNViewHolder = ITNViewHolder(parent, feedController)
...
class ITNViewHolder(parent: ViewGroup, val feedController: FeedController?) : androidx.recyclerview.widget.RecyclerView.ViewHolder(parent.inflate(R.layout.itn_item)) {
