...
public class GSyndicationFeedProvider extends AbstractRSSFeedProvider {

    public GSyndicationFeedProvider(Context c) {
        super(c);
    }
    ...
    public void bindFeed(BindCallback callback) {
        ...
        Executors.newSingleThreadExecutor().submit(() -> {
            ...
            parser.execute("https://news.google.com/rss?hl=en-US&gl=US&ceid=US:en");
