...
public class JustSearchSearchProvider extends ch.deletescape.lawnchair.globalsearch.SearchProvider {


    public JustSearchSearchProvider(@NotNull Context context) {
        super(context);
    }
    ...
    public boolean isAvailable() {
        try {
            getContext().getPackageManager().getPackageInfo("co.pxhouse.sas", 0);
            return true;
    ...
    public void startSearch(@NotNull Function1<? super Intent, Unit> callback) {
        Intent i = new Intent();
        i.setComponent(new ComponentName("co.pxhouse.sas", "co.pxhouse.sas.android.activity.AssistActivity"));
        callback.invoke(i);
    }
