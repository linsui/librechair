...
public class FennecSearchProvider extends ch.deletescape.lawnchair.globalsearch.SearchProvider {


    public FennecSearchProvider(@NotNull Context context) {
        super(context);
    }
    ...
    public boolean isAvailable() {
        try {
            getContext().getPackageManager().getPackageInfo("org.mozilla.fennec_fdroid", 0);
            return true;
    ...
    public String getName() {
        return getContext().getString(R.string.fennec_fdroid);
    }
