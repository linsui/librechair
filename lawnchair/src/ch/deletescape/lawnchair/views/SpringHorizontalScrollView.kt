...
open class SpringHorizontalScrollView @JvmOverloads constructor(
    ...
    init {
        if (Utilities.HIDDEN_APIS_ALLOWED) {
            getField<HorizontalScrollView>("mEdgeGlowLeft").set(this, springManager.createEdgeEffect(
                    DIRECTION_RIGHT, true))
            getField<HorizontalScrollView>("mEdgeGlowRight").set(this, springManager.createEdgeEffect(
                    DIRECTION_RIGHT, true))
        }
